odoo.define('pos_quick_payment_16.PaymentCreditPopup', function(require) {
    'use strict';
    ...
    // formerly PaymentCreditPopupWidget
    class PaymentCreditPopup extends AbstractAwaitablePopup {
        /**
         * @param {Object} props
    ...
    PaymentCreditPopup.template = 'PaymentCreditPopup';
    PaymentCreditPopup.defaultProps = {
        confirmText: _t('Ok'),
    ...
    Registries.Component.add(PaymentCreditPopup);

    return PaymentCreditPopup;
});
