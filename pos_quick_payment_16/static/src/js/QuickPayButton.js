odoo.define("pos_edit_order_line.QuickPayButton", function (require) {
    "use strict";
    ...
    class QuickPayButton extends PosComponent {
        setup() {
            super.setup();
    ...
    QuickPayButton.template = "QuickPayButton";

    ProductScreen.addControlButton({
        component: QuickPayButton,
    });

    Registries.Component.add(QuickPayButton);
